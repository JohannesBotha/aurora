    ...
    <div className="relative">
      <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100  lg:grid-cols-5">
        ...
        />
          ...
          <div className="max-w-md mt-4 text-green-800 dark:text-gray-400">
          ...
          <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
            {navigation.map((item, index) => (
              <Link
                key={index}
                href={item === "Home" ? "/" : item}
                className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-green-500 focus:text-green-500 focus:bg-pink-100 focus:outline-none dark:focus:bg-trueGray-700"
              >
                {item}
              </Link>
            ))}
      ...
      <div className="my-10 text-sm text-center text-green-600 dark:text-gray-400">
